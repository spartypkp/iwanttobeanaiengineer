...
import { Code, Coffee, Github, Laptop, Linkedin, Server, Terminal, Twitter, User } from 'lucide-react';
...
export const Hero: React.FC<HeroProps> = ({
	...
	return (
		<section className="py-16 md:py-24 relative">
			...
			<div className="relative z-10 container mx-auto px-4 flex flex-col md:flex-row items-center gap-6 md:gap-12">
				{/* Left side - Content */}
				<div className="flex-1 space-y-6 relative">
					{/* Terminal header styling - simplified, non-interactive */}
					<div className="terminal-header mb-3 rounded-t-md bg-black/70 p-2 flex items-center">
					...
					{/* Terminal content area - simplified */}
					<div className="space-y-3 crt-effect p-5 bg-black/50 border border-primary/30 rounded-b-md relative">
						{/* Subtle scan lines */}
